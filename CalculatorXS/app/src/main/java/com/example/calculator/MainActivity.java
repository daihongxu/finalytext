...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView = (TextView) findViewById(R.id.input);//输入文本
        final TextView textView1 = (TextView) findViewById(R.id.output);//输出文本
        ...
        equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double result = calculate.complexCalculate(temp);//计算结果
                if (result==Double.MAX_VALUE) {
                    textView1.setText("输入有错误");
                }
                else{
